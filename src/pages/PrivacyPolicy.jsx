        ...
        <div className="flex flex-col">
          ...
          <LegalSection title="7. Your Rights">
            ...
            <div className="bg-white/[0.03] border-l-4 border-cyan-400 p-6 rounded-r-xl">
              ...
              <p className="font-bold text-white text-lg tracking-wide">{t('contact.info.email.value')}</p>
          ...
          <LegalSection title="10. Children's Privacy">
            <p>
              Our services are not directed to individuals under the age of 18. We do not knowingly collect personal information from children. If you are a parent or guardian and believe your child has provided us with personal information, please contact us immediately at <span className="text-white">{t('contact.info.email.value')}</span> and we will take steps to delete such information.
            </p>
          </LegalSection>
          ...
          <LegalSection title="12. Contact Us">
            <div className="bg-white/[0.03] border-l-4 border-cyan-400 p-8 rounded-r-xl">
              ...
              <div className="space-y-1">
                ...
                <p className="text-cyan-400 font-medium">Email: {t('contact.info.email.value')}</p>
